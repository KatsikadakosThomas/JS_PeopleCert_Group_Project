...
module.exports = {
    ...
    fn: async function () {
     ...
     {name:"Cappuccino", description:"Cappuccino is an Italian coffee made with espresso and steam-foamed milk. It is believed that it developed from kapuziner—a coffee-based beverage that was enjoyed in Austrian coffee houses in the 18th century.", price:2.4,image: "/images/shop/Italian/Cappuccino.jpg", categoryID:1},
     {name:"Espresso", description:"The coffee used for espresso is blended from several roasts and as a result of pressurized brewing, the flavors of the beverage are very concentrated, with thick and almost syrupy texture. Consequently, espresso has more caffeine than other coffee beverages, so it is traditionally served as a shot.", price:2.2,image: "/images/shop/Italian/Espresso.jpg", categoryID:1},
     {name:"Macchiato", description:"Original Italian macchiato is a coffee variety that is made by pulling a shot of espresso and topping it with only one or two teaspoons of steamed milk. The milk is only added to enhance the flavor of coffee, and should never be overpowering.", price:2.5,image: "/images/shop/Italian/Macchiato.jpg", categoryID:1},
     {name:"Red Eye", description:"Red eye is an American coffee variety that combines brewed coffee with an espresso shot. This coffee combination is stronger than regular coffee, and it is supposed to be a more potent stimulant that keeps you awake and improves concentration.", price:2.9,image: "/images/shop/American_(USA)/Red_Eye.jpg", categoryID:2},
     {name:"Long Black", description:"Long black is a coffee variety that is often considered to be a close relative of caffé Americano. They both combine an espresso shot with hot water, but unlike its counterpart, long black is prepared by pouring or directly extracting the espresso into a cup of hot water.", price:2.7,image: "/images/shop/Australian/Long_Black.jpg", categoryID:3},
     {name:"Flat White", description:"Flat white is a coffee variety that couples a double shot of freshly brewed espresso and milk, which is usually steamed to create a light, silky microfoam. A perfect flat white should have an intense coffee flavor, and milk should only be a complement, not a predominant element, while the froth on top should be less airy and bubbly than in the classic cappuccino or caffè latte.", price:1.7,image: "/images/shop/Australian/Flat_White.jpg", categoryID:3},
     ...
     {name:"Café bombón", description:"Bombón coffee is a Valencian specialty that combines coffee and condensed milk. The drink is usually made with espresso, and it is assembled by pouring condensed milk first and then topping it with espresso.", price:1.8,image: "/images/shop/Spanish/Cafe_bombon.jpg", categoryID:6},
     {name:"Café del tiempo", description:"Roughly translated as weather coffee, café del tiempo is a variety of Spanish ice coffee. It consists of a cup of coffee that is served with a glass that is filled with ice cubes and occasionally a slice of lemon. The guest then sweetness the coffee according to taste before pouring it over ice.This coffee is mainly prepared with plain espresso or espresso that is topped with steamed milk.", price:2.3,image: "/images/shop/Spanish/Cafe_del_tiempo.jpg", categoryID:6},
